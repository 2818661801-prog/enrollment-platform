<!--
  AppFooter.vue · 底部信息（数据来源：杭州电子科技大学信息工程学院官网 hziee.edu.cn）
  3 列深色底 → 移动端纵向堆叠
-->
<template>
...
.footer-col {
  flex: 1 1 0;                     /* 三列等宽 */
  min-width: 260px;                /* logo 加大后列宽也要增加 */
...
.footer-col h4 {
  color: #fff;
  font-size: 15px;
  margin: 0 auto 10px;             /* 居中 + 下方间距 */
  padding-bottom: 6px;
  border-bottom: 1px solid #475569; /* 略亮的分隔线 */
  display: inline-block;           /* 边框只跟文字宽度 */
}
...
@media (max-width: 768px) {
  ...
  .footer-logo {
    margin-bottom: 0;               /* logo 下方边距去掉，让 logo 紧贴下方分割线 */
    flex: 0 0 auto;
  }
  .footer-logo-img {
