...
CREATE TABLE `ssc_classes` (
  ...
  `enrolled`    INT          DEFAULT 0               COMMENT '已弃用：曾用作已报名人数，现已弃用',
...
(1, '2026级拔尖创新人才实验班（杭电班）',
 ...
 60, 0, 0, 'admin', '***REMOVED***_test2026'),
(2, '2026级计算机科学与技术（成电联合培养·计算机学院成电班）',
 '2026/09/01 08:00 - 2026/09/13 23:59',
 45, 0, 0, 'admin', '***REMOVED***（成电联合培养班咨询群）'),
(3, '2026级电子信息工程（成电联合培养·电子工程学院成电班）',
 '2026/09/01 08:00 - 2026/09/13 23:59',
 35, 0, 0, 'admin', '邮箱:***REMOVED***'),
(4, '2026级会计学ACCA班',
 '2026/08/15 08:00 - 2026/09/16 23:59',
 50, 0, 0, 'admin', '***REMOVED***_teacher（ACCA班李老师）'),
(5, '2026级金融学CFA班',
 '2026/08/15 08:00 - 2026/09/16 23:59',
 50, 0, 0, 'admin', '***REMOVED***_teacher（CFA班王老师）'),
(6, '2026级会计学（智能财务）特色方向班',
 '2026/08/15 08:00 - 2026/08/25 23:59',
 39, 0, 0, 'admin', '***REMOVED***_test2026（智能财务方向咨询）'),
(7, '2026级湖畔实验班（计算机）',
 '2026/08/05 08:00 - 2026/08/15 23:59',
 30, 0, 0, 'admin', '邮箱:***REMOVED***（湖畔实验班咨询）');
