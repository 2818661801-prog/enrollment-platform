...
INSERT INTO `ssc_classes` (`id`, `name`, `period`, `periods`, `quota`, `enrolled`, `is_deleted`, `category_names`, `source`) VALUES
(1, '2026级拔尖创新人才实验班（杭电班）',
 '2026/09/01 08:00 - 2026/09/13 23:59',
 '[{"round":1,"period":"2026/09/01 08:00 - 2026/09/13 23:59"}]',
 60, 0, 0, '["经管类","理工类"]', 'admin'),
(2, '2026级计算机科学与技术（成电联合培养·计算机学院成电班）',
 '2026/09/01 08:00 - 2026/09/13 23:59',
 '[{"round":1,"period":"2026/09/01 08:00 - 2026/09/13 23:59"},{"round":2,"period":"2026/09/15 08:00 - 2026/09/16 23:59"}]',
 45, 0, 0, NULL, 'admin'),
...
(4, '2026级会计学ACCA班',
 ...
 '[{"round":1,"period":"2026/08/15 08:00 - 2026/09/16 23:59"}]',
 50, 0, 0, NULL, 'admin'),
(5, '2026级金融学CFA班',
 '2026/08/15 08:00 - 2026/09/16 23:59',
 '[{"round":1,"period":"2026/08/15 08:00 - 2026/09/16 23:59"}]',
...
(6, '2026级会计学（智能财务）特色方向班',
 ...
 '[{"round":1,"period":"2026/08/15 08:00 - 2026/08/25 23:59"}]',
 39, 0, 0, NULL, 'admin'),
(7, '2026级湖畔实验班（计算机）',
 '2026/08/05 08:00 - 2026/08/15 23:59',
 '[{"round":1,"period":"2026/08/05 08:00 - 2026/08/15 23:59"}]',
 30, 0, 0, NULL, 'admin');

-- ---------- 6. 初始数据：sys_config ----------
INSERT INTO `ssc_sys_config` (`cfg_key`, `cfg_value`, `updated_by`) VALUES
